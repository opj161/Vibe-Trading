...
class SignalEngine:
    def generate(self, data_map: Dict[str, pd.DataFrame]) -> Dict[str, pd.Series]:
        ...
        result = pd.concat([crypto_result, macro_result], axis=1)[symbols].clip(-1.0, 1.0)
