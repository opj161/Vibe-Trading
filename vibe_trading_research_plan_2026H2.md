...
| NEW: China A value+momentum composite | **Promising lead, not yet validated** | §69.3: adding a free (akshare, no token) inverse-P/B value tilt to the negative pure-momentum pilot rescued it — Sharpe 0.50 vs. control's 0.38 vs. pure-momentum's 0.13, DSR 79.7% (2-trial). Caveats: only 19 trades, single window, no point-in-time universe. Needs a proper broader-universe DSR/PBO-disciplined build before being trusted — the best next P2.1 follow-up. |
